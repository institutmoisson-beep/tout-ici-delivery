      ...
      <AuthProvider>
        <CartProvider>
          <div className="min-h-screen flex flex-col">
            ...
            <footer className="border-t border-border/50 py-8 mt-16 text-center text-xs text-muted-foreground">
              <p className="font-display text-base">Tout'<span className="text-primary-glow">ICI</span></p>
              <p className="mt-2">Marketplace gastronomique ivoirien · <Link to="/cgu" className="underline hover:text-foreground">Conditions d'utilisation</Link></p>
            </footer>
          </div>
